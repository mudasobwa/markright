defmodule Markright.Collectors.Test do
           ...
           [
             ...
             {:p, %{},
              [
                {:figure, %{},
                 [
                   {:img, %{alt: "alt text", src: "http://example.com/picture.png"}, nil},
                   {:figcaption, %{}, "alt text"}
                 ]}
              ]},
             {:p, %{},
  ...
  @accumulated [
    {Sample, [:h1, :blockquote, :figure, :pre, :p, :p, :p, :article]},
    {Markright.Collectors.OgpTwitter,
     [
       ...
       {:meta,
        %{
          content: "http://example.com/picture.png",
          name: "twitter:image:src",
          property: "og:image"
        }, nil},
       {:meta, %{content: "★★★", name: "twitter:site", property: "og:site_name"}, nil},
       {:meta,
        %{content: "Welcome to the real world!", name: "twitter:title", property: "og:title"},
        nil},
       {:meta,
        %{
          content:
  ...
  @output {:article, %{},
           [{:p, %{}, "Section 1."}, {:p, %{}, "Lorem ipsum and the seven little kids."}]}

  @accumulated [{Sample, []}, {Markright.Collectors.Fuerer, {:h2, %{}, "Section 1."}}]
  ...
  @output {:article, %{}, [{:p, %{}, "Section 1."}]}

  @accumulated [
    {Sample, []},
    {Markright.Collectors.Type,
     %Markright.Collectors.Type{decorated: false, tech: nil, type: :twit}}
  ]
  ...
  test "harvests info about tech" do
    ...
    assert type == %Markright.Collectors.Type{
             decorated: false,
             tech: ~w|ruby elixir|,
             type: :default
           }
